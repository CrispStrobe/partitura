/// Browser entry point: compiles `crisp_notation_core` to WebAssembly and exposes a
...
///   crisp_notationConvert(notes, format) -> String   // format: musicxml|mscx|abc
///   crisp_notationInfo(notes)            -> String    // one-line summary
...
@JS('crisp_notationConvert')
external set _convertFn(JSFunction value);

@JS('crisp_notationInfo')
