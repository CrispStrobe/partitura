...
///
/// This is the OMR pipeline factored out of the `partitura omr` command so any
...
/// Typical use:
/// ```dart
/// import 'package:partitura_cli/omr.dart';
///
...
///   };
///   // … render / export `score` with partitura_core.
/// } finally {
///   engine.dispose();
/// }
/// ```
...
// score model (re-exported from partitura_core so one import is enough).
